<?php
// Edição de Curso
if(isset($_GET['editCurso']))
{
  include_once('D:\xampp\htdocs\sistema\conexao.php') ;
    $pes =$_GET['editCurso'];
    $sql ="SELECT * FROM curso WHERE id = $pes;";
    $result = mysqli_query($conexao, $sql);
}
else if(isset($_POST['updateCurso'])){
    echo('recebi');
}
?>
<!DOCTYPE html>
...
<h1 class="title-box-main">Editando Curso</h1>
</header>
<div class="div-content-box py-2">

<form action="salve_inser.php" method="post">
<label>Nome do Curso</label>
<input type="text" name="editarC" value="<?php 
...
<input class="btn btn-primary mt-3" id="submit" type="submit" name="updateCurso" value="Editar">
</div>
</form>
</div>
</div>

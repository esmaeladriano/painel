        ...
        <div class="row">
            <div class="col-12">    
              <div class="col mt-3 search">
                ...
                <a href="http://localhost/sistema/painel\adim\cad-curso.php"> 
                ...
                <div class="box">
                    <div class="div-title-box">       
                        <span class="title-box-main  d-flex justify-content-center">Todos Cursos</span>
                    </div>       
                    <table id="tabela-scroll" class="table">
                      ...
                      <tbody>
                        ...
                        while($dados = mysqli_fetch_assoc($result))
                        {
                            ...
                            echo "<td> 
                            <a href='http://localhost/sistema/painel/adim/editarC.php?editCurso=$dados[id]'>
                            <button class='btn btn-primary'> </button>
                            </a>
                            <a href='http://localhost/sistema/painel/adim/delete.php?deletCurso=$dados[id] '>

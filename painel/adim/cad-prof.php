...
<h1 class="title-box-main  d-flex justify-content-center">Cadastro de Professores</h1>
</header>
<div class="container">
<form class="py-3">
<div class="row">
...
<li><input type="text" name="data" class="date" data-mask="0000/00/00" placeholder="Ex.: 2000/12/05" required></li>

<li><label>Nº do BI</label></li>
<li><input type="text" name="BI" class="BI" placeholder="BI" pattern="[0-9]{9}[A-Za-z]{2}[0-9]{3}"></li>
...
<li>
    ...
    <!-- <input type="text" name="genre" placeholder="M/F/O" pattern="[M,m,F,f,O,o]{1}"> -->
</li>
...
<script type="text/javascript" src="js copy/slide.js"></script>		  </div>
</div>
</div>
</div> 

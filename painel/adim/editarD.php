...
if(isset($_GET['editDisc']))
{
  include_once('D:\xampp\htdocs\sistema\conexao.php') ;
    $pes =$_GET['editDisc'];
    $sql ="SELECT * FROM disciplina WHERE id = $pes;";
...
<h1 class="title-box-main">Editando Disciplina</h1>
</header>
<div class="div-content-box py-2">

<form action="salve_inser.php" method="post">
<label>Nome do Curso</label>
<input type="text" name="editarD" value="<?php 
...
<input class="btn btn-primary mt-3" id="submit" type="submit" name="updateDisc" value="Editar">
</div>
</form>
</div>
</div>
